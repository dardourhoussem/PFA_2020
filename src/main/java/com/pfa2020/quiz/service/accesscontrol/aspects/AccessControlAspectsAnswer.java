...
public class AccessControlAspectsAnswer {
	...
	@Around("execution(* com.pfa2020.quiz.repository.AnswerRepository.save(..)) && args(answer)")
	...
	@Around("execution(* com.pfa2020.quiz.repository.AnswerRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.pfa2020.quiz.repository.AnswerRepository.findAll())")
	...
	@Around("execution(* com.pfa2020.quiz.repository.AnswerRepository.delete(..)) && args(answer)")
