...
public class AccessControlAspectsQuestion {
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuestionRepository.save(..)) && args(question)")
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuestionRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuestionRepository.findAll())")
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuestionRepository.delete(..)) && args(question)")
