...
public class AccessControlAspectsQuiz {
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuizRepository.save(..)) && args(quiz,..)")
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuizRepository.find(Long)) && args(id)")
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuizRepository.findAll())")
	...
	@Around("execution(* com.pfa2020.quiz.repository.QuizRepository.delete(..)) && args(quiz)")
